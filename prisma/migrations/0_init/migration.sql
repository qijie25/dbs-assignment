...
-- AddForeignKey
ALTER TABLE "review" ADD CONSTRAINT "member_id_fk" FOREIGN KEY ("memberid") REFERENCES "member"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "review" ADD CONSTRAINT "product_id_fk" FOREIGN KEY ("productid") REFERENCES "product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "review" ADD CONSTRAINT "sale_order_id_fk" FOREIGN KEY ("orderid") REFERENCES "sale_order"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
